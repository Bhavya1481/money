...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText add_new_person;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText = findViewById(R.id.add_new_person);
...
//                        Intent viewRecordsIntent = new Intent(MainActivity.this, ExpenseListActivity.class);
//                        startActivity(viewRecordsIntent);
//                        return true;
//                    case R.id.btnAddGroup:
//                        Toast.makeText(MainActivity.this, "Group functionality is under construction", Toast.LENGTH_SHORT).show();
//                        return true;
//
//                }
//                return false;
...
//        // Initialize Views
//        listViewPersons = findViewById(R.id.listview_persons);
//        addNewPerson = findViewById(R.id.add_new_person);
//        searchView = findViewById(R.id.search_view);
//        BottomNavigationView bottomNavigationView = findViewById(R.id.bottom_navigation);
//
...
//        addNewPerson.setOnEditorActionListener((v, actionId, event) -> {
//            String newPerson = addNewPerson.getText().toString().trim();
//            if (!newPerson.isEmpty()) {
//                personList.add(newPerson);
//                personAdapter.notifyDataSetChanged();
//                savePersonList(personList);
//                addNewPerson.setText("");  // Clear input after adding
//            } else {
//                Toast.makeText(MainActivity.this, "Please enter a person's name", Toast.LENGTH_SHORT).show();
//            }
//            return true;
